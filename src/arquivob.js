  ...
  fetch(URLU)
    ...
    .then(dados => {
      ...
      modalForm.onsubmit = (event) => {
        ...
        // Aqui você pode acessar os dados do agendamento do formulário e fazer o que precisar

        // Atualiza os dados do usuário com os novos valores do modal
        barbeiro.nome = document.getElementById('nome').value;
        barbeiro.telefone = document.getElementById('telefone').value;
